...
const ROLE_LINKS = {
  ...
  PANEL_MEMBER: [
    { to: '/admin/interviews', label: 'My assigned interviews' },
  ],
};
...
export default function AdminDashboard() {
  ...
  return (
    <div>
      <h1 className="font-heading text-2xl font-bold text-secondary">Staff Dashboard</h1>
      ...
      <Card className="mt-8">
        <p className="text-sm text-muted">
          Bulk reports (shortlists, applications, selections) are displayed as downloadable PDF documents
          for official record-keeping and printing.
        </p>
      </Card>
    </div>
  );
