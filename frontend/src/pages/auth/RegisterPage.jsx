    ...
    <div className="flex min-h-[70vh] items-center justify-center px-4 py-12">
      <Card className="w-full max-w-md">
        <div className="mb-6 text-center">
          ...
          <h1 className="mt-2 font-heading text-2xl font-bold text-primary">Applicant Registration</h1>
        ...
        {success ? (
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <Input label="Phone number" required value={form.phoneNumber} onChange={update('phoneNumber')} />
